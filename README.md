        ...
        <div class="main" id="topchartsDiv">
            ...
            <table width="100%" id="topTable">
                <tr height="80px">
                    ...
                    <td>Among Us<br><span class="appCategory">Action&nbsp;&nbsp<i class="fa fa-circle fa-xs"></i>&nbsp;&nbsp;Multiplayer</span><br><span class="appCategory">4.5<span class="fa fa-star"></span> &nbsp;72MB</span></td>
                </tr>
                <tr height="80px">
        ...
        <div class="title1">
            ...
            <div class="wideShow">
                <table style="border-spacing:8px 0px;">
                    <tr>
                        <td>
                            <img src="https://dl.dropbox.com/s/ds2hoeet30kx829/thimbleweed-wide.webp" class="widePic">
                        </td>
                        <td>
                            <img src="https://dl.dropbox.com/s/0u6n4nax8mhpyiu/minecraft-wide.webp" class="widePic">
                        </td>
                        <td>
                            <img src="https://dl.dropbox.com/s/4tl4uc0ormqrx0e/farming-sim-wide.webp" class="widePic">
                        </td>
                        <td>
                            <img src="https://dl.dropbox.com/s/pjefpvllotjst8d/five-nights-wide.jpg" class="widePic">
                        </td>
                        <td>
                            <img src="https://dl.dropbox.com/s/5byxp1j2psgeewb/monument-wide.jpg" class="widePic">
                        </td>
                        <td>
                            <img src="https://dl.dropbox.com/s/wl4uyh6y4gcp9ed/the-room-wide.webp" class="widePic">
                        </td>
                        <td>
                            <img src="https://dl.dropbox.com/s/73gpn5dnaouhdtd/terraria-wide.webp" class="widePic">
                        </td>
                    </tr>
                </table>
                <table cellspacing="8px">
